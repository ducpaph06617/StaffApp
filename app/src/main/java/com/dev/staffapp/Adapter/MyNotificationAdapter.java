...
import com.dev.staffapp.Common.MyDiffCallBack;
...
public class MyNotificationAdapter extends RecyclerView.Adapter<MyNotificationAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position) {
        ...
        myViewHolder.txt_notification_title.setText(myNotificationList.get(position).getTitle());
        myViewHolder.txt_notification_content.setText(myNotificationList.get(position).getContent());
